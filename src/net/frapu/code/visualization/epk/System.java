 ...
 * @author fpu
 */
public class System extends ProcessNode {
    ...
    protected void paintInternal(Graphics g) {
        ...
        g2.drawLine(getPos().x-getSize().width/2+4, getPos().y-getSize().height/2,
                getPos().x-getSize().width/2+4, getPos().y+getSize().height/2);
