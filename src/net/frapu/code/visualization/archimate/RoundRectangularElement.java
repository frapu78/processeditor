 ...
 * @author fpu
 */
public abstract class RoundRectangularElement extends Cluster {

    public static final String PROP_SHOW_ONLY_SYMBOL = "symbol_only";

    public RoundRectangularElement() {
        super();
        setSize(80, 50);
    ...
    protected Shape getOutlineShape() {
        Point p = getTopLeftPos();
        Dimension d = getSize();
        return new RoundRectangle2D.Double(p.x, p.y, d.width, d.height, 20, 20);
    }
